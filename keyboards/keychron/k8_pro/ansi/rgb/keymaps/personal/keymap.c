...
// clang-format off
enum layers{
  MAC_BASE_DVORAK = 0, // Win/Android physical switch
  WIN_BASE_QWERTY = 2, // Mac/iOS physical switch
  FN,
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
[MAC_BASE_DVORAK] = LAYOUT_tkl_ansi(
...
[WIN_BASE_QWERTY] = LAYOUT_tkl_ansi(
     KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,             KC_PSCR,   KC_CTANA, RGB_MOD,
...
[FN] = LAYOUT_tkl_ansi(
     ...
     KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  BAT_LVL,  NK_TOGG,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,             KC_A,
